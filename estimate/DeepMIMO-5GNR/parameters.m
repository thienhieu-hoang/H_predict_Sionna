...
params.scenario = 'O1_3p4';          % The adopted ray tracing scenario [check the available scenarios at https://deepmimo.net/scenarios/]
...
params.CDL_5G.Velocity = [1, 5]; % UE velocity in km/h -
...
% Antenna panel size:
params.CDL_5G.bsAntSize = [1, 8];  % Number of rows and columns in rectangular BS array
% If there are multiple active antennas are available, and different
